...
from app.input_sim import move_to, click_left, ctrl_wheel
...
class TouchZoomController:
    """
    - 캘리브 없이 z0/σ를 적응 추정해 '터치' 판단
    - 터치 중 검지-엄지 핀치 변화로 Ctrl+Wheel Zoom
    - touch_polarity: auto/pos/neg 지원
    """
